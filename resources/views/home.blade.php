    ...
    <div class="bg-gray-800 rounded-2xl p-4 shadow">
        <form method="POST" action="{{ route('posts.store') }}" enctype="multipart/form-data">
            ...
            <div class="flex justify-between items-center mt-2">
                ...
                <button type="submit"
                        class="bg-blue-600 hover:bg-blue-700 px-5 py-2 rounded-xl font-semibold">Post</button>
            </div>
        </form>
    </div>
    @endauth
        ...
        <div class="comments-section mt-2 hidden space-y-2">
            ...
            <form class="comment-form flex items-center mt-2">
                <input type="text" name="body"
                       class="flex-1 rounded-full border-gray-700 bg-gray-900 px-3 py-1 text-sm text-gray-100"
